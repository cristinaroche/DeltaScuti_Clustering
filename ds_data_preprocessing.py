# Reads the database of stars in .dat format and processes the features for each star.
# This version includes the cathegorical output of the non-linear features in its last paragraphs.
...
for i, filename in enumerate(all_stars_files):
    ...
    with open(filename, 'r') as f:
        ...
        if armonics_first == 0:
            ...
            stars_dict[var_name]['armonics_first_cat'] = 3
